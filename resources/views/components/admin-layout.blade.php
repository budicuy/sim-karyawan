<x-layout>
    <div x-data="{ sidebarOpen: false }" class="flex min-h-screen bg-gray-100">
        ...
        <div x-show="sidebarOpen" 
             x-cloak
             class="fixed inset-y-0 left-0 z-30 w-64 transition duration-300 transform bg-blue-800 lg:transform-none lg:opacity-100 lg:relative lg:inset-0 text-white shadow-lg"
            ...
            <div class="p-4 font-bold text-xl bg-blue-900 border-b border-blue-700 flex justify-between items-center">
                ...
                <button @click="sidebarOpen = false" class="p-2 rounded-md lg:hidden hover:bg-blue-800">
